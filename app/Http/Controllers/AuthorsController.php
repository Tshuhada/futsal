...
class AuthorsController extends Controller
{
    ...
    {
      $this->validate($request, ['nama' => 'required|unique:authors']);
      $author = Author::create($request->all());
      Session::flash("flash_notification", [
        "level"=>"success",
        "message"=>"Berhasil Menyimpan $author->nama"
      ]);
    ...
    {
      $this->validate($request, ['nama' => 'required|unique:authors,nama,'. $id]);
      $author = Author::find($id);
